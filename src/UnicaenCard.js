...
const UnicaenCard = ({ unicaenLogo }) => {
  return (
    <div
      className="career-card text-justify h-full flex flex-col relative overflow-hidden outline-none data-[focus-visible=true]:z-10 data-[focus-visible=true]:outline-2 data-[focus-visible=true]:outline-offset-2 shadow-md rounded-lg motion-reduce:transition-none font-[600] sm:font-[700] text-[1rem] sm:text-[1.25rem] lg:text-[1.5rem]"
      tabIndex="-1"
    >
