...
const Career = () => {
  return (
    <div id="career" className="felx flex-col justify-center items-center text-justify h-[150vh] max-w-[55%] mx-auto space-y-10 text-[1.5rem] font-extrabold relative z-10">
      <h1 className="text-[4rem] text-clr-2">Career</h1>
